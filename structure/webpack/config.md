...
* **output配置**
    ...
    - libraryTarget  配置如何暴露library，可选的值为：var、this、window、global、commonjs、commonjs2、amd、amd-require、umd等。通常使用umd即可，umd是一种混合规范，可以将library暴露为所有的模块定义下都可运行的方式，可以在CommonJS, AMD环境下运行，兼容性最好。
